...
const ActionDetailNameDisplay = (props) => {
            ...
            if(listData.length){
                return listData.map((item)=>{
                    ...
                    <div className="container-fluid ActionDetailDisplayContainer">
                        ...
                        <div className="row ActionDetailDisplayEffect"><h3>Effect</h3><br></br>
                        {item.effect}</div><br></br>
                        <br></br>
...
export default ActionDetailNameDisplay;